            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('tickets.store') }}">
                    ...
                    <div class="mb-3 text-start">
                        ...
                        <textarea class="form-control" name="descripcion" rows="3" required placeholder="Por favor describe a detalle la situación y uno de nuestros técnicos se encargará de resolverla"></textarea>
                    </div>
